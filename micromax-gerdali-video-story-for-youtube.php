...
function micromax_gerdali_enqueue_assets() {
	wp_register_style( 'micromax-gerdali-style', plugin_dir_url( __FILE__ ) . 'assets/css/youtube-story-videos.css', array(), '1.7.3' );
	wp_register_script( 'micromax-gerdali-script', plugin_dir_url( __FILE__ ) . 'assets/js/youtube-story-videos.js', array(), '1.7.3', true );
			...
			<div class="micromax-gerdali-dashboard">
				...
				<header class="micromax-gerdali-header">
					...
					<div class="micromax-gerdali-header-right">
						<span class="micromax-gerdali-version-tag">v1.7.3</span>
					</div>
				</header>
							...
							<section class="micromax-gerdali-card">
								...
								<div class="status-grid">
									<div class="status-row">
										...
										<span class="status-value highlight">1.7.3</span>
									</div>
									<div class="status-row">
